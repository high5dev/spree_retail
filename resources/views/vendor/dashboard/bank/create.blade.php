                ...
                <div class="card-body">
                    <form action="{{route('vendor.dashboard.product.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputText3" name="name" type="text" class="form-control @error('name') is-invalid @enderror">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input id="quantity" name="quantity" type="number" placeholder="Quantity" class="form-control @error('quantity') is-invalid @enderror">
                            @error('quantity')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="price" name="price" type="number" class="form-control @error('price') is-invalid @enderror" placeholder="Price">
                            @error('price')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>
