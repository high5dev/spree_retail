                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        @if($account != null)
                                                <tr>
                                                    <td>{{$account->business_profile->name ?? 'Not Available'}}</td>
                                                    <td>{{$account->payouts_enabled == 1 ? 'Enabled' : 'Disabled'}}</td>
                                                    <td>{{$account->capabilities->transfers == 1 ? 'Enabled' : 'Disabled'}}</td>
                                                    <td>${{$balance->available[0]->amount/100}}</td>
                                                    <td>{{$VendorStripe->status}}</td>
                                                    <td>{{$VendorStripe->created_at}}</td>
                                                    <td>
