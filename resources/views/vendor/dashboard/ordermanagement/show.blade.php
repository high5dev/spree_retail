    ...
    <div class="dashboard-wrapper">
        ...
        <div class="container mt-0">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('vendor.dashboard.ordermanagement.store', $order_product->id )}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="shipped_quantity" class="form-control form-control-sm" value="{{$order_product->quantity}}" disabled>
                            <input type="number" name="shipped_quantity" class="form-control form-control-sm" value="{{$order_product->quantity}}" hidden>
