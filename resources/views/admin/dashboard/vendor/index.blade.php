...
{{--                                    <li class="breadcrumb-item" aria-current="page">Vendor Index</li>--}}
{{--                                </ol>--}}
{{--                            </nav>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <div class="ml-auto d-inline-flex">
                                ...
                                <form id="create" action="{{route('admin.dashboard.vendor.create')}}" method="GET"></form>
                                <button form="request" class="btn btn-primary " >Requests</button>
                                <form id="request" action="{{route('admin.dashboard.vendor.request')}}" method="GET"></form>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                @if(count($users) > 0)
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.dashboard.vendor.edit',$user->id)}}" style="color: blue" class="btn">
                                                    Edit
                                                </a>
