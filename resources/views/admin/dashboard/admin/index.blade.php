...
{{--                                    <li class="breadcrumb-item" aria-current="page">Admin Index</li>--}}
{{--                                </ol>--}}
{{--                            </nav>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <form id="create" action="{{route('admin.dashboard.admin.create')}}" method="GET"></form>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                @if(count($users) > 0)
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.dashboard.admin.edit',$user->id)}}" style="color: blue" class="btn">
                                                    Edit
                                                </a>
                                                <a href="" onclick="event.preventDefault();document.getElementById('delete-{{$user->id}}').submit()" style="color: red" class="btn">
                                                    Delete
                                                </a>
                                                <form id="delete-{{$user->id}}" action="{{route('admin.dashboard.admin.destroy',$user->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
