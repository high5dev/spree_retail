                ...
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <a href="{{route('admin.dashboard.ordermanagement.index')}}" class="mt-2">View all<i class="ml-2 fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h1 class=" text-primary">{{$ship_count}}</h1>
                            <h5 class="text-primary">Orders</h5>
                        </div>
                        <div class="card-footer text-center">
                            <a href="{{route('admin.dashboard.ordermanagement.shipped')}}" class="mt-2">View all <i class="ml-2 fas fa-arrow-circle-right"></i> </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h1 class=" text-primary">{{$acknwoledge_count}}</h1>
                            <h5 class="text-primary">Orders</h5>
                        </div>
                        <div class="card-footer text-center">
                            <a href="{{route('admin.dashboard.ordermanagement.acknowledged')}}"> View all <i class="ml-2 fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h1 class="text-primary">{{$cancel_count}}</h1>
                            <h5 class="text-primary">Orders</h5>
                        </div>
                        <div class="card-footer text-center">
                            <a href="{{route('admin.dashboard.ordermanagement.canceled')}}" class="mt-2">View all <i class="ml-2 fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    @if(count($order_products) > 0)
                                        @foreach($order_products as $order)
                                            <tr>
                                                ...
                                                @endif                                        
                                                <td>
                                                    <a href="{{ route('admin.dashboard.ordermanagement.show', $order->id) }}" style="color: blue" class="btn">
                                                        View
                                                    </a>
                                                </td>
                                            </tr>
