    ...
    <div class="dashboard-wrapper">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.dashboard.banner.update', ['id' =>$banner->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="description">Url</label>
                            <textarea class="form-control @error('url') is-invalid @enderror" id="url" name="url" rows="2" >{{$banner->url}}</textarea>
                            @error('url')
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control" id="main">
                                ...
                                <option value="1" {{$banner->type=='Header'?'selected':''}}>Header</option>
                                <option value="2" {{$banner->type=='Footer'?'selected':''}}>Footer</option>
                            </select>
                            @error('main_category')
                            <div class="invalid-feedback">
