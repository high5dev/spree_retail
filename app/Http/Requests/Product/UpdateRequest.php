...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'length' => 'required|numeric|gte:1|lte:30',
            'width' => 'required|numeric|gte:1|lte:30',
            'height' => 'required|numeric|gte:1|lte:30',
            'weight' => 'required|numeric|gte:1|lte:140',
            'size' => 'required',
            'type_size' => 'required',
            'color' => 'required'
        ];
    ...
    public function withValidator($validator)
    {
        ...
        //     if ($girth > 90){
        //         $validator -> errors() -> add('popup_error', 'Please select girth of 90 inches in total.Packages up to 150 lbs., 30" in length and 90" in length plus girth (L+2W+2H) can be shipped.');
        //     }
