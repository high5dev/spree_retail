                        ...
                        <div class="splide__slide m-1">
                            <div class="p-4">
                                <div class="card" style="margin-bottom: 1rem">
                                    <a href="<?php echo e(route('product.show',$product->slug)); ?>"><img class="img-fluid" src="<?php echo e(asset('storage/storage/product/'.$product->thumbnail)); ?>"></a>
                                </div>
                                <div class="mt-2">
                    ...
                    <div class="splide__list">
                        ...
                        <div class="splide__slide m-1">
                            <div class="p-4">
                                ...
                                <div class="mt-2">
                                    <p class="text-bold mb-1"><?php echo e($product->user->name); ?></p>
                                    <p title="Source Title" style="font-size: 13px" class="mb-1"><?php echo e($product->name); ?></p>
                                    <p class="text-bold">$<?php echo e($product->price); ?>.00</p>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Game\Downloads\SPREE-master\resources\views/pages/home.blade.php ENDPATH**/ ?>