        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('vendor.dashboard.order.index')); ?>" ><i class="fa fa-fw fa-rocket"></i>Order</a>
                    </li>
                    <li class="nav-item">
...
<?php /**PATH /home/nirjhar/PROJECTs/JONES/spree/resources/views/vendor/inc/dashboardVendorSidebar.blade.php ENDPATH**/ ?>