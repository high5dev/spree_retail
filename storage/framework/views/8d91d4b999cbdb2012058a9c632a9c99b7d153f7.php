...
<div>
    ...
    <?php if(count($h_banners) > 0): ?>
        <div id="demo" class="carousel slide" data-ride="carousel">
            <ul class="carousel-indicators">
                <li data-target="#demo" data-slide-to="0" class="active"></li>
                <li data-target="#demo" data-slide-to="<?php echo e(count($h_banners)); ?>"></li>
            </ul>
            <div class="carousel-inner">
                <?php $__currentLoopData = $h_banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h_banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php if($loop->iteration == 1): ?>active <?php endif; ?>">
                        <a href="">
                            <img src="<?php echo e(asset('storage/banner/'.$h_banner->image)); ?>" width="100%">
                        </a>
                    </div>
...
<article>
        ...
        <div class="mt-2 mb-2">
            <div class="container-fluid">
                <div class="d-flex space-between fs-15 mt-3" style="    margin-top: 44px !important;">
                    ...
                    <div class="shopAll">
                        <a href="<?php echo e(URL::to('product')); ?>" style="font-weight: 600;margin-right: 120px">Shop All <i class="fa fa-chevron-right"></i>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <?php $__currentLoopData = $new_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="splide__slide m-1">
                            ...
                            <div class="card" style="margin-bottom: 1rem">
                                <a href="<?php echo e(route('product.show',$product->slug)); ?>"><img class="img-fluid" src="<?php echo e(asset('storage/product/'.$product->thumbnail)); ?>"></a>
                            </div>
                            <div class="mt-2">
    ...
    <?php if(count($f_cats) > 0): ?>
        <?php $__currentLoopData = $f_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <?php if(count($products) > 0): ?>
                <div class="mt-2 mb-2">
                    <div class="container-fluid">
                        <div class="d-flex space-between fs-15 mt-3" style="    margin-top: 44px !important;">
                            <div>
                                <h4 class="fs-15" style="margin-left: 28px;margin-bottom: 20px"> <b><?php echo e($f_cat->name); ?></b> </h4>
                            </div>
                            <div class="shopAll">
                                <a href="<?php echo e(URL::to('/product/featured/'.$f_cat->name)); ?>" style="font-weight: 600;margin-right: 120px">Shop All <i class="fa fa-chevron-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
            <?php if(!is_null($f_banner)): ?>
                <div class="container-fluid">
                    <div class="col-sm-12 footer_banner" style="background-image: url(<?php echo e(asset('storage/banner/'.$f_banner->image)); ?>);width: 90%;margin-left: 2rem;margin-top: 6rem">
                    </div>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nirjhar/PROJECTs/JONES/spree/resources/views/pages/home.blade.php ENDPATH**/ ?>