                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <div class="ml-auto d-inline-flex">
                                <button form="create" class="btn btn-primary mr-1" >Create</button>
                                <form id="create" action="<?php echo e(route('admin.dashboard.vendor.create')); ?>" method="GET"></form>
                                <button form="request" class="btn btn-primary " >Requests</button>
                                <form id="request" action="<?php echo e(route('admin.dashboard.vendor.request')); ?>" method="GET"></form>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <?php if(count($users) > 0): ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.dashboard.vendor.edit',$user->id)); ?>" style="color: blue" class="btn">
                                                    Edit
                                                </a>
...
<?php echo $__env->make('admin.layouts.dashboardAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/admin/dashboard/vendor/index.blade.php ENDPATH**/ ?>