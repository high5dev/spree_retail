                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <form id="create" action="<?php echo e(route('admin.dashboard.admin.create')); ?>" method="GET"></form>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <?php if(count($users) > 0): ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.dashboard.admin.edit',$user->id)); ?>" style="color: blue" class="btn">
                                                    Edit
                                                </a>
                                                <a href="" onclick="event.preventDefault();document.getElementById('delete-<?php echo e($user->id); ?>').submit()" style="color: red" class="btn">
                                                    Delete
                                                </a>
                                                <form id="delete-<?php echo e($user->id); ?>" action="<?php echo e(route('admin.dashboard.admin.destroy',$user->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.dashboardAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/admin/dashboard/admin/index.blade.php ENDPATH**/ ?>