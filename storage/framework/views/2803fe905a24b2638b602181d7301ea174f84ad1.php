                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <form id="create" action="<?php echo e(route('vendor.dashboard.product.create')); ?>" method="GET"></form>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <?php if(count($products) > 0): ?>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('vendor.dashboard.product.edit',$product->slug)); ?>" style="color: blue" class="btn">
                                                    Edit
                                                </a>
                                                ...
                                                <form id="delete-<?php echo e($product->id); ?>" action="<?php echo e(route('vendor.dashboard.product.destroy',$product->slug)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('vendor.layouts.dashboardVendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/vendor/dashboard/product/index.blade.php ENDPATH**/ ?>