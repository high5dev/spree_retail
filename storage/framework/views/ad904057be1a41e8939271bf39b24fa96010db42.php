                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                    ...
                                    <?php $__currentLoopData = $order_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if($order->delivered == 0): ?>
                                                <td class="text-warning">Shipping</td>
                                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <td colspan="9" class="text-center mt-3">No Shipping data to show</td>
                                <?php endif; ?>
                                </tbody>
                                <tfoot>
                                </tfoot>
...
<?php echo $__env->make('vendor.layouts.dashboardVendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/vendor/dashboard/ordermanagement/shipping.blade.php ENDPATH**/ ?>