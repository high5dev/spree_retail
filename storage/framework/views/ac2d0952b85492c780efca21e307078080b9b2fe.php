...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="container mt-0">
                ...
                <div class="col-12">
                    <div class="text-center">
                        <h5 class="bold">Status: 
                            ...
                            <?php elseif($order_product->status == 1): ?>
                                <span class="text-primary">Acknowledged</span>
                            <?php elseif($order_product->status == 2): ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                        ...
                        <div class="row ml-2">
                            ...
                            <div class="col-6">
                                <h5 class="price-summary ml-auto"><?php echo e($order_product->product()->first()->user()->first()->first_name); ?> <?php echo e($order_product->product()->first()->user()->first()->last_name); ?></h5>
                            </div>
                        </div>
                        <div class="row ml-2">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <h5 class="price-summary ml-auto"><?php echo e($order_product->product()->first()->user()->first()->email); ?></h5>
                            </div>
                        </div>
                        <?php if($order_product->status == 0): ?>
                            <div class="row ml-2">
                                ...
                                <div class="col-6">
                                    <h5 class="price-summary ml-auto"><?php echo e($order_product->created_at->diffForHumans()); ?></h5>
                                </div>
                            </div>
                        <?php elseif($order_product->status == 1): ?>
                            <div class="row ml-2">
                                ...
                                <div class="col-6">
                                    <h5 class="price-summary ml-auto"><?php echo e($order_product->updated_at->diffForHumans()); ?></h5>
                                </div>
                            </div>
                            <?php elseif($order_product->status == 2): ?>
                            <div class="row ml-2">
                            ...
                            <div class="row ml-2">
                                ...
                                <div class="col-6">
                                    <h5 class="price-summary ml-auto"><?php echo e($order_product->tracking_number); ?></h5>
                                </div>
                            </div>
                        <?php elseif($order_product->status == 3): ?>
                            <div class="row ml-2">
                                <div class="col-6">
                        ...
                        <?php elseif($order_product->status == 4): ?>
                            <div class="row ml-2">
                                <div class="col-6">
                                    <h5 class="sub-total">Canceled at</h5>
                                </div>
                            ...
                            <?php elseif($order_product->status == 5): ?>
                            <div class="row ml-2">
                                <div class="col-6">
                                    <h5 class="sub-total">Canceled at</h5>
                                </div>
            ...
            <hr>
            <?php if($order_product->status == 2): ?>
                <button form="frmDelivered" class="btn btn-outline-primary mb-3">Approve Delivery</button>
                <form id="frmDelivered" action="<?php echo e(route('admin.dashboard.ordermanagement.delivered', $order_product->id)); ?>" method="POST" hidden>
                    <?php echo csrf_field(); ?>
                </form>
            <?php endif; ?>
            <?php if($order_product->status == 0 || $order_product->status == 1 || $order_product->status == 2 ): ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <form id="formCancel" action="<?php echo e(route('admin.dashboard.ordermanagement.canceltransaction', $order_product->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.dashboardAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/admin/dashboard/ordermanagement/detail.blade.php ENDPATH**/ ?>