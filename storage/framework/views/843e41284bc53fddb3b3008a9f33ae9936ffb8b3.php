    ...
    <div class="dashboard-wrapper">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('vendor.dashboard.product.update',$product->slug)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select multiple name="parent_category[]" class="form-control" id="parent">
                                ...
                                <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(in_array($item->name, $product->categories->pluck('name')->toArray())): ?>
                            ...
                            <select onChange="typeSizeSelected(this);" name="type_size" class="form-control" id="type_size" onChange="typeSizeSelected(this);" >
                                ...
                                <?php if(count($type_sizes) > 0): ?>
                                    <?php $__currentLoopData = $type_sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($product->type_size_id == $item->id): ?>
                        ...
                        <div class="form-group">
                            ...
                            <select multiple name="color[]" id="color" class="form-control">
                                ...
                                <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($productColors->contains('color_id', $color->id)): ?>
...
<?php echo $__env->make('vendor.layouts.dashboardVendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/vendor/dashboard/product/edit.blade.php ENDPATH**/ ?>