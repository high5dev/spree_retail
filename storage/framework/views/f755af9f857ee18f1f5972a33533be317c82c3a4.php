            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input disabled id="inputText3" value="<?php echo e($product->id); ?>" name="first_name" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="first_name" class="col-form-label">Product name</label>
                        <input disabled id="inputText3" value="<?php echo e($product->name); ?>" name="first_name" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="first_name" class="col-form-label">Quantity</label>
                        <input disabled id="inputText3" value="<?php echo e($product->quantity); ?>" name="first_name" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="first_name" class="col-form-label">Remaining</label>
                        <input disabled id="inputText3" value="<?php echo e($product->remaining); ?>" name="first_name" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="first_name" class="col-form-label">Required</label>
                        <input disabled id="inputText3" value="<?php echo e($product->required); ?>" name="first_name" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="first_name" class="col-form-label">Dispatched</label>
                        <input disabled id="inputText3" value="<?php echo e($dispatched); ?>" name="first_name" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <a class="btn btn-primary" target="_blank" href="<?php echo e(route('product.show',$product->slug)); ?>">View Details</a>
                    </div>
                    ...
                    <form class="form-control" id="form-product" action="<?php echo e(route('vendor.dashboard.order.store',$product->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
...
<?php echo $__env->make('vendor.layouts.dashboardVendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mypc\laravelprojects\Jones\spree (1)\spree\resources\views/vendor/dashboard/order/send.blade.php ENDPATH**/ ?>